        ...
        mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false)
{
    ...
    cv::FileNode mapfileOutn = fsSettings["Map.mapfileOut"];

    if (!mapfileOutn.empty())
    {
        mapfileOut = (string)mapfileOutn;
    }
...
////////////////////////////////////////////////////qwq
    ...
    f<<"Now printing the point list for the cloud"<<endl;
...
void System::SaveMap(const string &filename)
{
    ...
    if (!out)
    {
        cerr << "Cannot Write to Mapfile: " << mapfileOut << std::endl;
        exit(-1);
    }
    cout << "Saving Mapfile: " << mapfileOut << std::flush;
...
//    unique_lock<mutex> lock();
   ...
   ifstream source(mapfile, ios::binary);
   ofstream dest("map_backup.bin", ios::binary);
